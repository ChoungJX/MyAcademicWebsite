...
function HomePage() {
    ...
    const data = {
        "english": {
            ...
            AboutMe: (
                <div>
                    ...
                    I am interested in diverse research topics that optimize software performance for modern high-performance CPUs across diverse computing environments. Now, I am a research assistant supervised by <a style={{ borderBottom: '1px solid #454746' }} href="https://hiroshi-sasaki.github.io/index-en.html">Dr. Hiroshi Sasaki</a> at <a style={{ borderBottom: '1px solid #454746' }} href="https://titech-caras.github.io/index-en.html">CARAS Lab</a>.
                    <br />
            ...
            Notification: [
                { "date": "2024-02-24", "news": "Update UI" },
        ...
        "chinese": {
            ...
            AboutMe: (
                <div>
                    我在<a style={{ borderBottom: '1px solid #454746' }} href="https://www.titech.ac.jp/">东京工业大学</a>情報通信系获得了硕士学位并正在继续攻读博士学位。
                    <br />
                    我对跨不同计算环境优化现代高性能 CPU 的软件性能的各种研究主题感兴趣。我的指导老师是<a style={{ borderBottom: '1px solid #454746' }} href="https://hiroshi-sasaki.github.io/index-en.html">佐々木　広教授</a>。
                    <br />
                    在东工大读硕士之前，我在<a style={{ borderBottom: '1px solid #454746' }} href="https://www.cqupt.edu.cn">重庆邮电大学</a>软件工程学院获得了学士学位。
                </div>
            ),
            Notification: [
                { "date": "2024-02-24", "news": "UI更新" },
