...
function HomePage() {
  ...
  const data = {
    english: {
      ...
      AboutMe: (
        <div>
          I received my Master's degree and am currently pursuing my PhD in
          ...
          <a
            style={{ borderBottom: "1px solid #454746" }}
            href="https://titech-caras.github.io/index-en.html"
          >
            CARAS Lab
          </a>
          .
          <br />
          Before studying at Tokyo Tech, I completed my bachelor’s in Software
          Engineering at{" "}
          <a
            style={{ borderBottom: "1px solid #454746" }}
          ...
          , where I worked on some projects related to big data and machine
          learning (NLP and Face Recognition) at CQUPT E-evidence Collection and
      ...
      Experience: [
        ...
        },
        {
          ...
          city: "Chongqing China",
          content:
            "Implemented a Face Recognition Platform that was won the first prize of the 8th iSoftstone cup campus development competition.",
          icon: (
            <FaceRetouchingNaturalTwoToneIcon style={{ color: "#444746" }} />
          ),
          color: "secondary",
        },
        {
          ...
          city: "Chongqing China",
          content:
            "Designed and implemented NLP algorithms for <Chongqing Daily> Public Sentiment System that was shown at Chongqing International Cultural Industries Fair in September 2018.",
        ...
        },
        {
          ...
          city: "Chongqing China",
          content:
            "Developed visual management system for Gluster distributed file system.",
    ...
    chinese: {
      ...
      Experience: [
        ...
        },
        {
          ...
          city: "中国，重庆",
          content:
            "开发了一个基于人脸识别的签到平台，该平台获得第八届“软件盛典”软通动力杯校园开发大赛一等奖。",
          icon: (
            <FaceRetouchingNaturalTwoToneIcon style={{ color: "#444746" }} />
          ),
          color: "secondary",
        },
        {
          ...
          city: "中国，重庆",
          content:
            "为《重庆日报》理论舆情系统开发了一套自然语言处理算法，该平台在2018年9月在重庆文博会展览。",
          icon: <AbcTwoToneIcon style={{ color: "#444746" }} />,
          color: "secondary",
        },
        {
  ...
  return (
    <HomePageContent
      data={showData}
      Language={UILang}
      switchLanguage={(language: "english" | "chinese") =>
